local function B1B2H_Black(msg)
...
database:sadd(bot_id.."ModyTEaM:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ModyTEaM:blocname"..msg.chat_id_)
...
function B1B2H_name(t1,t2)
if t2.id_ then 
name_Black = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Black then 
names_Black = database:smembers(bot_id.."ModyTEaM:blocname"..msg.chat_id_) or ""
...
bnnaGet(msg.sender_user_id_, B1B2H_name)
end
end
return {
ModyTEaM = B1B2H_Black,
}
